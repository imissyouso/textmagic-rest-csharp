...
namespace TextMagicClient.Model
{
    ...
    public partial class GetContactsResponse :  IEquatable<GetContactsResponse>, IValidatableObject
    {
        ...
        public GetContactsResponse(int? page = default(int?), int? pageCount = default(int?), int? limit = default(int?), List<Contact> resources = default(List<Contact>))
        {
            // to ensure "page" is required (not null)
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for GetContactsResponse and cannot be null");
            }
            else
            {
                this.Page = page;
            ...
            if (pageCount == null)
            {
                throw new InvalidDataException("pageCount is a required property for GetContactsResponse and cannot be null");
            }
            else
            {
            ...
            if (limit == null)
            {
                throw new InvalidDataException("limit is a required property for GetContactsResponse and cannot be null");
            }
            else
            {
                this.Limit = limit;
            ...
            if (resources == null)
            {
                throw new InvalidDataException("resources is a required property for GetContactsResponse and cannot be null");
            }
            else
            {
