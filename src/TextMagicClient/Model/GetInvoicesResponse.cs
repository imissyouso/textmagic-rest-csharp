...
namespace TextMagicClient.Model
{
    ...
    public partial class GetInvoicesResponse :  IEquatable<GetInvoicesResponse>, IValidatableObject
    {
        ...
        public GetInvoicesResponse(int? page = default(int?), int? pageCount = default(int?), int? limit = default(int?), List<Invoice> resources = default(List<Invoice>))
        {
            // to ensure "page" is required (not null)
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for GetInvoicesResponse and cannot be null");
            }
            else
            {
                this.Page = page;
            ...
            if (pageCount == null)
            {
                throw new InvalidDataException("pageCount is a required property for GetInvoicesResponse and cannot be null");
            }
            else
            {
            ...
            if (limit == null)
            {
                throw new InvalidDataException("limit is a required property for GetInvoicesResponse and cannot be null");
            }
            else
            {
                this.Limit = limit;
            ...
            if (resources == null)
            {
                throw new InvalidDataException("resources is a required property for GetInvoicesResponse and cannot be null");
            }
            else
            {
