...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupImage :  IEquatable<GroupImage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupImage" /> class.
        /// </summary>
        ...
        public GroupImage(string href = default(string))
        {
            // to ensure "href" is required (not null)
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for GroupImage and cannot be null");
            }
            else
            {
                this.Href = href;
        ...
        {
            return this.Equals(input as GroupImage);
        }

        /// <summary>
        /// Returns true if GroupImage instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupImage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupImage input)
        {
            if (input == null)
                return false;
